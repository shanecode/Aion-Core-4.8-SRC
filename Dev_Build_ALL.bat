...
SET TITLE=Build
TITLE InsaneAion - %TITLE% Panel
:MENU
CLS
ECHO.
ECHO   ^*--------------------------------------------------------------------------^*
ECHO   ^|                    InsaneAion Project - %TITLE% Panel                ^|
ECHO   ^*--------------------------------------------------------------------------^*
ECHO   ^|                                                                          ^|
...
ECHO   ^|    5 - Build All                                                         ^|
ECHO   ^|                 Modified by Ghostfur for using ANT  (use 7 then *)       ^|
ECHO   ^*--------------------------------------------------------------------------^*
ECHO.
:ENTER
...
ECHO.
ECHO   ^*--------------------------------------------------------------------------^*
ECHO   ^|                    InsaneAion Project - Install Panel                ^|
ECHO   ^*--------------------------------------------------------------------------^*
ECHO   ^|                                                                          ^|
...
ECHO.
ECHO   ^*--------------------------------------------------------------------------^*
ECHO   ^|                    InsaneAion Project - Debug Panel                  ^|
ECHO   ^*--------------------------------------------------------------------------^*
ECHO   ^|                                                                          ^|
