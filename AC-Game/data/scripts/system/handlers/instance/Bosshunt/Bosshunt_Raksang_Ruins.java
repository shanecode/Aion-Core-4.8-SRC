...
public class Bosshunt_Raksang_Ruins extends GeneralInstanceHandler {
    ...
    protected boolean isInstanceDestroyed = false;
         ...
         */
            ...
            public void onInstanceCreate(WorldMapInstance instance) {
                ...
                spawn(219934, 638.0212f, 696.1726f, 522.0487f, (byte) 15); // Prectaz Boss ID + Position
        								...
        								public void run() {
        									instance.doOnAllPlayers(new Visitor<Player>() {
        										...
        										public void visit(Player player) {		
        											PacketSendUtility.sendMessage(player, "Prectaz Boss will go off in 5 min!");
        										}
        									});
        								}
        							}, 60000); //1 Minutes.
        							...
        							TWD2Task = ThreadPoolManager.getInstance().schedule(new Runnable() {
        								...
        								public void run() {
        									instance.doOnAllPlayers(new Visitor<Player>() {
        										@Override
        										public void visit(Player player) {
        											PacketSendUtility.sendMessage(player, "Prectaz Boss will go off in 1 min!");
        										}
        									});
        								}
        							}, 300000); //5 Minutes.
	 ...
	 @Override
	        ...
	        switch (npc.getObjectTemplate().getTemplateId()) {   
	            case 219934: // Prectaz Boss    	
	              	for (Player p: player.getPlayerGroup2().getMembers()){		
						...
						ItemService.addItem(p, 188508008, 1);	//Motion card Socialite Special
	    ...
	    public boolean onReviveEvent(Player player) {
	        ...
	        return TeleportService2.teleportTo(player, mapId, instanceId, 662.52765f, 668.46985f, 522.0487f, (byte) 75);
	    }
}