...
public class TrapNpcAI2 extends NpcAI2 {
    ...
    private void tryActivateTrap(Creature creature) {
        ...
        //}
        int time = 1000;
        if (this.getNpcId() == 833190 || this.getNpcId() == 833189) {
        ...
        if (!creature.getLifeStats().isAlreadyDead() && isInRange(creature, getOwner().getAggroRange() + 2)) {
            ...
            //The Last 2 Trap NpcId's skill has removed on 4.8.
            if (this.getNpcId() == 833190 || this.getNpcId() == 833189 || this.getNpcId() == 749250 || this.getNpcId() == 749251) {
                time = 5000;
            }
