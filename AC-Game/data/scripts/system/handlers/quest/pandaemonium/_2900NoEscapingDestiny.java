 ...
 * @author Mr. Poke
 * @reworked vlog
 * @modified Rolandas, apozema, pralinka(for 4.8)
 */
						...
						case SELECT_ACTION_3058: {
							if (var == 96) {
								if (giveQuestItem(env, getStoneId(player), 1) && !isStigmaEquipped(env)) {
									long kinah = player.getInventory().getItemCountByItemId(182400001); //182400001 kinah
									if (kinah < 2000) {
											ItemService.addItem(player, 182400001, 2000 - kinah);
