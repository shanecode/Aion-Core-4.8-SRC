          ...
          if(params[0].equals("show")){
            ...
            PacketSendUtility.sendMessage(player, "==================================");
              ...
              if (params.length == 2) {//eventcaller start {number of player}
                  ...
                  while(ita.hasNext()){
                      Player p1 = ita.next();
                      PacketSendUtility.sendSys2Message(p1, player.getName(), "[EVENT] Registering for Event has Started! Type .queue to register to the event! ( '"+countP+"' Slots Available)");
                  }
              ...
              while(ita.hasNext()){
                  ...
                  p1.setRegedEvent(false);
                  PacketSendUtility.sendSys2Message(p1, player.getName(), "[EVENT] Event has been Canceled!");
              }
