...
/**
 * @author ATracer, modidied by @Voidstar
 */
public class StatCapUtil {
    ...
    public static int getUpperCap(StatEnum stat) {
        ...
        switch (stat) {
            case SPEED:
                value = CustomConfig.MAX_SPEED;
                break;
            case FLY_SPEED:
                value = CustomConfig.MAX_FLY_SPEED;
                break;
            case MAGICAL_ACCURACY:
                value = CustomConfig.MAX_MAGICAL_ACCURACY;
                break;
            case BOOST_MAGICAL_SKILL:
                value = CustomConfig.MAX_BOOST_MAGICAL_SKILL;
                break;
            case PHYSICAL_ACCURACY:
                value = CustomConfig.MAX_PHYSICAL_ACCURACY;
                break;
            case PHYSICAL_CRITICAL:
