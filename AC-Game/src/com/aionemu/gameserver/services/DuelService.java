...
public class DuelService {
    ...
    private void startDuel(Player requester, Player responder) {
        ...
        sendDuelStartMessage(requester, responder);
    ...
    public void loseDuel(Player player) {
        ...
        if (opponent != null) {
            ...
            sendDuelEndMessage(opponent, player);
    ...
    private void createTask(final Player requester, final Player responder) {
        ...
        PacketSendUtility.sendPacket(requester, new SM_QUEST_ACTION(0, 303));
        PacketSendUtility.sendPacket(responder, new SM_QUEST_ACTION(0, 303));
