...
public enum RiftEnum {
	...
	/*THEOBOMOS_AM(2160, "THEOBOMOS_AM", "BRUSTHONIN_AS", 50, 45, 50, Race.ASMODIANS),
    THEOBOMOS_BM(2161, "THEOBOMOS_BM", "BRUSTHONIN_BS", 50, 45, 50, Race.ASMODIANS),
    THEOBOMOS_CM(2162, "THEOBOMOS_CM", "BRUSTHONIN_CS", 50, 45, 50, Race.ASMODIANS),
    THEOBOMOS_DM(2163, "THEOBOMOS_DM", "BRUSTHONIN_DS", 50, 45, 50, Race.ASMODIANS),
    THEOBOMOS_EM(2164, "THEOBOMOS_EM", "BRUSTHONIN_ES", 50, 45, 50, Race.ASMODIANS),*/
	...
	/*BRUSTHONIN_AM(2250, "BRUSTHONIN_AM", "THEOBOMOS_AS", 50, 45, 50, Race.ELYOS),
    BRUSTHONIN_BM(2251, "BRUSTHONIN_BM", "THEOBOMOS_BS", 50, 45, 50, Race.ELYOS),
    BRUSTHONIN_CM(2252, "BRUSTHONIN_CM", "THEOBOMOS_CS", 50, 45, 50, Race.ELYOS),
    BRUSTHONIN_DM(2253, "BRUSTHONIN_DM", "THEOBOMOS_DS", 50, 45, 50, Race.ELYOS),
    BRUSTHONIN_EM(2254, "BRUSTHONIN_EM", "THEOBOMOS_ES", 50, 45, 50, Race.ELYOS),*/
