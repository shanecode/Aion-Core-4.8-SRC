...
public class PlayerRestrictions extends AbstractRestrictions {
    ...
    public boolean canUseSkill(Player player, Skill skill) {
        ...
        if (!CustomConfig.ABYSS_TRANSFORM && skill.getSkillTemplate().getStack().contains("ABYSS_RANKERSKILL")) {
            PacketSendUtility.sendWhiteMessage(player, "[" + GSConfig.SERVER_NAME + "] Abyss Transformation has been disabled!");
            return false;
        }
